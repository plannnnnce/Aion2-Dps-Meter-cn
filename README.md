...
2. [이동](https://github.com/TK-open-public/Aion2-Dps-Meter/releases) 해당 링크에서 aion2meter4j-0.2.0.msi을 다운받아 설치합니다. (1번과 순서 무관)
...
6. 만약 미터가 그려지지 않는다면, 키벨리스크나 아지트로 이동하면서 테스트를 해보거나(던전 내부에서 키벨리스크 이동 포함) 3번과 4번을 반복합니다.
7. 잘 동작하다가 어느 순간 끊긴 경우에는 위 6번과 동일하게 키벨리스크 이동이나 던전 진입 등을 통해 높은 확률로 데이터를 받아옵니다. 그래도 동작하지 않는다면 3번 4번을 다시 진행하세요.
